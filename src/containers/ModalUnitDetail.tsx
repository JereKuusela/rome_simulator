...
import { UnitType, UnitDefinition, UnitCalc, setBaseValue, setModifierValue, ArmyType } from '../store/units'
...
interface IDispatchFromProps {
  close: () => void,
  setBaseValue: (army: ArmyType, type: UnitType, value_type: UnitType | UnitCalc, key: string, value: number) => void,
  setModifierValue: (army: ArmyType, type: UnitType, value_type: UnitType | UnitCalc, key: string, value: number) => void
}
...
const mapDispatchToProps = (dispatch: any): IDispatchFromProps => ({
  ...
  setBaseValue: (army: ArmyType, type: UnitType, value_type: UnitType | UnitCalc, key: string, value: number) => (
    !Number.isNaN(value) && dispatch(setBaseValue(army, type, value_type, key, value))
  ),
  setModifierValue: (army: ArmyType, type: UnitType, value_type: UnitType | UnitCalc, key: string, value: number) => (
