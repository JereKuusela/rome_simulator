      ...
      <Grid padded>
        <Grid.Row columns='2'>
          <Grid.Column>
            ...
            <List>
              <List.Item>1. Select which parts to export (resets any manual changes)</List.Item>
              {this.attributes.map(value => this.renderCheckbox(value))}
              <List.Item>
                2a.{' '}
                <Button primary onClick={() => saveToFile(this.state.data)}>
                  Export to file
                </Button>
              </List.Item>
              <List.Item>2b. Copy paste the data from the text box</List.Item>
            </List>
            ...
            <List>
              ...
              <List.Item>3. Push the button</List.Item>
              <List.Item>
                <Button primary onClick={() => this.props.importState(this.state.data, this.props.resetMissing)}>
                  Import
                </Button>
              </List.Item>
            </List>
            <Header>Reset</Header>
            <List>
              <List.Item>Reset all data (battle, countries, units, tactics, terrains, settings)</List.Item>
              <List.Item>
                <Button negative onClick={() => this.props.importState('', true)}>
                  Reset
                </Button>
              </List.Item>
            </List>
