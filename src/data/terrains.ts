import { ValuesType, DefinitionType, TerrainType, LocationType, TerrainCalc, Terrain, TerrainValueType, Terrains } from 'types'
...
const createTerrainFromJson = (data: TerrainData): Terrain => {
  let terrain: Terrain = {type: data.type as TerrainType, mode: data.mode as DefinitionType, image: IconTerrain, location: data.location as LocationType}
