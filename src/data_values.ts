 ...
 */
export const mergeValues = <D1 extends BD | undefined, D2 extends BD | undefined>(
  definition: D1,
  toMerge: D2
): D1 & D2 => {
 ...
 */
export const addValues = <D extends BD>(
  definition: D,
  type: ValuesType,
  key: string,
...
export const addValue = <D extends BD>(
  definition: D,
  type: ValuesType,
  key: string,
  attribute: string,
...
export const addValuesWithMutate = <D extends BD>(
  definition: D,
  type: ValuesType,
  key: string,
  values: [string, number][]
 ...
 */
const subAddValues = <A extends string>(
  container: Values<A> | undefined,
  key: string,
  values: [A, number][]
): Values<A> => {
 ...
 */
export const regenerateValues = <D extends BD, A extends string>(
  definition: D,
  type: ValuesType,
  key: string,
  values: [A, number][]
...
const subFilterValues = (values: Values<any> | undefined, filterKey: string) =>
 ...
 * @param attribute
 */
export const calculateValueWithoutLoss = <D extends BD, A extends string>(
 ...
 * @param attribute
 */
export const calculateBase = <D extends BD, A extends string>(definition: D, attribute: A): number =>
 ...
 * @param attribute
 */
export const calculateModifier = <D extends BD, A extends string>(definition: D, attribute: A): number =>
 ...
 * @param attribute
 */
export const calculateGain = <D extends BD, A extends string>(definition: D, attribute: A): number =>
 ...
 * @param attribute
 */
export const calculateLoss = <D extends BD, A extends string>(definition: D, attribute: A): number =>
 ...
 * @param attribute
 */
export const calculateLossModifier = <D extends BD, A extends string>(definition: D, attribute: A): number =>
 ...
 * @param key
 */
export const getValue = <D extends BD, A extends string>(
  type: ValuesType,
  definition: D,
  attribute: A,
  key: string
