...
export const getLeadingGeneral = (state: AppState, type: SideType, mode?: Mode): General => {
  ...
  return generals.sort((a , b) => b.total_values[GeneralAttribute.Martial] - a.total_values[GeneralAttribute.Martial])[0]
}
