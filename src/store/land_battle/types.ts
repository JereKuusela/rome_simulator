...
export const getInitialArmy = (): ParticipantState => ({ army: fromJS(Array(2).fill(Array(30).fill(null))), defeated_army: fromJS(Array(2).fill(Array(30).fill(null))), general: 0, tactic: null})